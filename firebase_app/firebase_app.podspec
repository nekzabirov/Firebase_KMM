Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/firebase_app.framework') || Dir.empty?('build/cocoapods/framework/firebase_app.framework')
        ...
        Kotlin framework 'firebase_app' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :firebase_app:generateDummyFramework

        Alternatively, proper pod installation is performed during Gradle sync in the IDE (if Podfile location is set)"
    end
                
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':firebase_app',
